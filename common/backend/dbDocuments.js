...
import CalendarMonths from "./documents/calendarMonths.mjs";
import CalendarDays from "./documents/calendarDays.mjs";
import Chapter from "./documents/chapter.mjs";
import ChapterType from "./documents/chapterType.mjs";
import Entry from "./documents/entry.mjs";
import Entity from "./documents/entity.mjs";
import EntryType from "./documents/entryType.mjs";
import EntryEvent from "./documents/event.mjs";
import LineageEntry from "./documents/lineageEntry.mjs";
import Section from "./documents/section.mjs";
import LineageTree from "./documents/lineageTree.mjs";
import Relevance from "./documents/relevance.mjs";
import BaseDocument from "./documents/base.mjs";
import Tome from "./documents/tome.mjs";
import Setting from "./documents/setting.mjs";
import TextImage from "./documents/textImage.mjs";
import MapAtlas from "./documents/map.mjs";
import MapElement from "./documents/mapElement.mjs";
...
export default class DBDocuments {
    ...
    constructor(data) {
        ...
        this.textImages = this.createGenericSet(data._textImages, TextImage);
        ...
        this.timelines = this.createTimelineSet(data.timelines, data._timelineEvents);
    ...
    createTimelineSet(timelines, timelineEvents) {
        ...
        timelines.forEach((timeline) => {
            ...
            te.forEach((te) => {
                eventSet.add(this.events.get(te.evid));
            });
